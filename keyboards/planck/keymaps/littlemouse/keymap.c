...
qk_tap_dance_action_t tap_dance_actions[] = {
  [TD_QT_SFT] = ACTION_TAP_DANCE_DOUBLE(KC_QUOT, KC_RSFT)
};
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D, LT(4,KC_F), KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
...
[_ADJUST] = LAYOUT_planck_grid(
    _______, QK_BOOT, DEBUG,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, KC_BRMU, KC_BRMD, _______,
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  _______, KC_VOLU, KC_VOLD, KC_MUTE,
...
[_MOUSE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, KC_BTN2,
